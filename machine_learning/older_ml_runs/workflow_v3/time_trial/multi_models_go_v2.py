...
Customised for go terms. Modified from multi_models_go.py in
~/machine_learning/workflow_v2
"""
import sys
import pandas as pd
...
lsv = LinearSVC(max_iter=10000000, random_state=42, class_weight='balanced')
