...
ML_FILE = 'slightly_bigger_test.txt'
MODEL_NAME = 'ada'
...
grid = {
    MODEL_NAME + '__n_estimators': randint(100, 151),
    MODEL_NAME + '__learning_rate': uniform(0.6, 0.8),
}
...
for train_index,test_index in outer_kf.split(X, y):
    ...
    hp_sr = RandomizedSearchCV(estimator=clf, param_distributions=grid,
                           n_iter=1, scoring='f1', cv=inner_kf, n_jobs=100)
