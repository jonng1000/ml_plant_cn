...
RF uses 1 process, grid search uses 100 processes

Reduced range of hp, so that script can completed, based from ml_bcw_whp_v2.py
"""
import sys
import pandas as pd
...
rf_grid = {
    'classifier__n_estimators': [50, 100, 300, 500, 100],
    'classifier__max_features': [50, 80, 200, 500, 1000],
    'classifier__max_depth': [5, 10, 20, 40, None],
    'classifier__ccp_alpha': [0, 0.0001, 0.0002, 0.0004, 0.001]
}
