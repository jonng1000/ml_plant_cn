...
Improved from rf_16cl_cv2.py, technically there's no v1 of this, but am
putting v2 just to make it consistent with my other ml scripts and to
prevent confusion. 100 processes used instead of 120 by other v2 scripts
"""
import sys
import os
import pandas as pd
...
for a_file in os.listdir(DATA_FOLDER):
    ...
    gd_sr = GridSearchCV(estimator=clf, param_grid=grid,
                         verbose=1, scoring='f1', cv=5, n_jobs=80)
