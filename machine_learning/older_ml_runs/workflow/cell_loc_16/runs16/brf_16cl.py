...
DATA_FOLDER = './data_16'
SCORES_FILE = 'brf_cell16_scores.txt'
...
for a_file in os.listdir(DATA_FOLDER):
    ...
    grid = {
        'brf__max_features': [40, 80, 200],
        'brf__n_estimators': [100, 200, 500],
        'brf__max_depth': [20, 50, None],
    }
