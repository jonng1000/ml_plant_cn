...
learning workflow without data leakage. Prints out the classification report. 
Column transformer, the specific classifier, and grid search have
the n_jobs parameter.

grid search uses mumtiple processes, 5-fold cv
"""
import sys
import pandas as pd
...
FT_FILE = sys.argv[2]  # feature types file
scores_file = sys.argv[3]  # name of model scores
...
# 'ada__base_estimator__max_features': [50, 80, 100, 200, 500],
# 'ada__n_estimators': [25, 50, 100, 500, 1000],
# Previously, I have 10 learning rate parameters, but it crashed
# hence used less now
grid = {
    'ada__n_estimators': [50],
    'ada__learning_rate': [1.26, 1.261, 1.263, 1.265, 1.267, 1.269,
                           1.27, 1.271, 1.273, 1.275, 1.277, 1.279,
                           1.28, 1.3] 
}
...
gd_sr = GridSearchCV(estimator=clf, param_grid=grid,
                     scoring='f1', cv=5, n_jobs=200, pre_dispatch=50)
