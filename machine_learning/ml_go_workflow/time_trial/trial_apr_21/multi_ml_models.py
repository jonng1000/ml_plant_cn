...
~/machine_learning/older_ml_runs/workflow_v3/time_trial
"""
import sys
import pandas as pd
...
brf = BalancedRandomForestClassifier(random_state=42, n_jobs=50)
rf = RandomForestClassifier(random_state=42, class_weight='balanced', n_jobs=50)
logr = LogisticRegression(solver='saga', n_jobs=50,
