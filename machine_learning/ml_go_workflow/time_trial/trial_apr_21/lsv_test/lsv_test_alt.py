...
# Models
lsv = LinearSVC(random_state=42, class_weight='balanced', max_iter=10000)
lsv2 = LinearSVC(random_state=42, class_weight='balanced', max_iter=100000)
lsv3 = LinearSVC(random_state=42, class_weight='balanced', max_iter=500000)
lsv4 = LinearSVC(random_state=42, class_weight='balanced', max_iter=1000000)
...
lsv2_output = {'fi': [], 'scores': []}
lsv3_output = {'fi': [], 'scores': []}
lsv4_output = {'fi': [], 'scores': []}
...
models = [(lsv_grid, lsv, lsv_output, 'lsv'),
          (lsv2_grid, lsv2, lsv2_output, 'lsv2'),
          (lsv3_grid, lsv3, lsv3_output, 'lsv3'),
          (lsv4_grid, lsv4, lsv4_output, 'lsv4')
]
