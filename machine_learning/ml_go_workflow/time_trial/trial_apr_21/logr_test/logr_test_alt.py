...
Customised for go terms. Modified from logr_test.py to test multiple
...
logr = LogisticRegression(solver='saga', max_iter=1000,
                          ...
                          n_jobs=50)
logr2 = LogisticRegression(solver='saga', max_iter=5000,
                           random_state=42, class_weight='balanced',
                           n_jobs=50)
logr3 = LogisticRegression(solver='saga', max_iter=10000,
                           random_state=42, class_weight='balanced',
                           n_jobs=50)
...
logr2_output = {'fi': [], 'scores': []}
logr3_output = {'fi': [], 'scores': []}
...
models = [(logr_grid, logr, logr_output, 'logr'),
          (logr2_grid, logr2, logr2_output, 'logr2'),
          (logr3_grid, logr3, logr3_output, 'logr3')]
