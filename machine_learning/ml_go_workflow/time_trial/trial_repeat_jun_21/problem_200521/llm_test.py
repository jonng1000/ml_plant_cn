...
models = [(100, logr, 'logr', logr_grid),
          (1000, logr2, 'logr2', logr2_grid),
          (5000, logr3, 'logr3', logr3_grid),
          (1000, lsv, 'lsv', lsv_grid),
          (10000, lsv, 'lsv2', lsv2_grid),
          (100000, lsv, 'lsv3', lsv3_grid),
          (500000, lsv, 'lsv4', lsv4_grid),
          (np.nan, rf, 'rf', rf_grid),
          (np.nan, ada, 'ada', ada_grid),
          (np.nan, brf, 'brf', brf_grid)]
...
for model in models:
    for i in range(1,6):
        ...
        hp_sr = RandomizedSearchCV(estimator=clf, param_distributions=model[3],
                               n_iter=20, scoring='f1', cv=inner_kf,
                               n_jobs=100)
