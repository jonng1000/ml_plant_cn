...
Customised for DGE terms. Modified from multi_go_wrapper.py
...
# downstream scripts
one_target = 'dge_' + TARGET
# Various scripts are possible
os.system('python rem_specific_dge.py ' + one_target
          + ' ' + ML_FILE)
os.system('python rf_dge.py ' + one_target)
