...
Based on rf_feature_extract.py, for importing.
Edited from D:\GoogleDrive\machine_learning
              \RF_PNAS\feature_extract\build_top_features
              \rfe_module_v2.py
"""
...
if __name__ == "__main__":
    # This section runs the above functions, builds a random
    # forest model, and calculates model scores and feature
    # importances
    # Code to write in another script when importing this script
    file = 'D:/GoogleDrive/machine_learning/RF_PNAS/fully_processed.txt'
    runs = 3
    ...
    for i in range(runs):
        ...
        balance_train = balancing(X_train, y_train, class_labels)
